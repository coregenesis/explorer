    ...
    >
      <Box flexGrow="1" mb={{ base: 8, lg: 0 }} minW="195px">
        ...
        <Box mt={{ base: 5, lg: '44px' }}>
          <Link fontSize="xs" href="https://genesiscore.org">genesiscore.org</Link>
        </Box>
        <Text mt={ 3 } maxW={{ base: 'unset', lg: '470px' }} fontSize="xs">
            Genesisscan is the blockchain explorer for the genesis network.
        </Text>
      </Box>
      <Grid
      ...
      >
        <Box>
          { config.UI.footer.links && <Text fontWeight={ 500 } mb={ 3 }>Genesis Core</Text> }
          <Grid
            gap={ 1 }
            gridTemplateColumns={
